...
const Q = [
  ...
  {c:5,t:"There is something in you that has survived everything. What is it?",o:["My care for others. Even depleted, I still show up for people.","My drive. I don't stop, even when I probably should.","My mind. My ability to see clearly, assess situations, and make sound decisions. Even when everything else has gone quiet, that has never failed me.","My ability to feel. Even when it's quiet, it's never fully gone."],s:["M","S","M","V"]},
  {c:5,t:"If you could send a message to yourself from five years ago, what would you say?",o:["I would tell her one specific thing to do differently. I know exactly which decision changed the trajectory.","It's going to cost you more than you think. Protect yourself.","I wouldn't know what to say. I can't remember who she was.","Don't lose her. The one who feels, who dreams, who sees beauty."],s:["M","S","D","M"]},
